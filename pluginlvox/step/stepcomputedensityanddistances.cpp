...
void StepComputeDensityAndDistances::createInResultModelListProtected()
{
    ...
    CT_InStandardItemDrawableModel *item = new CT_InStandardItemDrawableModel(DEF_SearchInScene, CT_Scene::staticGetType(), tr("ScËne"));
    group->addItem(item);
...
void StepComputeDensityAndDistances::compute()
{
    ...
    // ATTENTION
    // !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!! TO DO !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    // Modifier les fonctions ci-dessous pour qu'elles ne crÈent plus les grilles !!!
