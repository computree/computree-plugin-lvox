...
#ifndef STEPCOMPUTEDENSITYONLY_H
#define STEPCOMPUTEDENSITYONLY_H

/** \file stepcomputedensityonly.h
...
/** \class  StepComputeDensityOnly
    \brief  This step aims at discretizing in voxels a pointcloud scanned by a T-LiDAR and calculating for each voxel a density index.

            This index was presented in a previous article written by by J.F. Cote, J.L Widlowski, R.A. Fournier and M.M. Verstraete.
...
*/
class StepComputeDensityOnly : public CT_AbstractStep
{
    /** \def    Q_OBJECT :
...
public:
    ...
    */
    StepComputeDensityOnly(CT_StepInitializeData &dataInit);
...
#endif // STEPCOMPUTEDENSITYONLY_H
