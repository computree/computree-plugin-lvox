#include "lvox_stepcomparegrids.h"
...
LVOX_StepCompareGrids::LVOX_StepCompareGrids(CT_StepInitializeData &dataInit) : CT_AbstractStep(dataInit)
{
}

// Step description (tooltip of contextual menu)
QString LVOX_StepCompareGrids::getStepDescription() const
{
    return tr("7 - Compare two grids");
}

// Step detailled description
QString LVOX_StepCompareGrids::getStepDetailledDescription() const
{
    return tr("Takes two grids and outputs a new one containing difference on a voxel by voxel basis");
}

// Step URL
QString LVOX_StepCompareGrids::getStepURL() const
{
...
// Step copy method
CT_VirtualAbstractStep* LVOX_StepCompareGrids::createNewInstance(CT_StepInitializeData &dataInit)
{
    return new LVOX_StepCompareGrids(dataInit);
}

//////////////////// PROTECTED METHODS //////////////////

// Creation and affiliation of IN models
void LVOX_StepCompareGrids::createInResultModelListProtected()
{
...
void LVOX_StepCompareGrids::createOutResultModelListProtected()
{
...
void LVOX_StepCompareGrids::createPostConfigurationDialog()
{
    // No parameter dialog for this step
}

void LVOX_StepCompareGrids::compute()
{
    // Get the out res
