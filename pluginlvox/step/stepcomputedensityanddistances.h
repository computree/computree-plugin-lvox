...
#ifndef STEPCOMPUTEDENSITYANDDISTANCES_H
#define STEPCOMPUTEDENSITYANDDISTANCES_H

/** \file stepcomputedensityanddistances.h
...
/** \class  StepComputeDensityAndDistances
    \brief
*/
class StepComputeDensityAndDistances : public CT_AbstractStep
{
    /** \def    Q_OBJECT :
...
public:
    ...
    */
    StepComputeDensityAndDistances(CT_StepInitializeData &dataInit);
...
#endif // STEPCOMPUTEDENSITYANDDISTANCES_H
